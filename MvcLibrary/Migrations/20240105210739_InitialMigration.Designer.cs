...
namespace MvcLibrary.Migrations
{
    ...
    [Migration("20240105210739_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MvcLibrary.Models.Adherent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("MvcLibrary.Models.Adherent", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Reservation", b =>
                {
                    ...
                    b.HasOne("MvcLibrary.Models.Adherent", "User")
                        .WithMany("Reservations")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
